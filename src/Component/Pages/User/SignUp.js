                ...
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit(handleSignUp)}>
                        ...
                        <label for="dropzone-file" className="flex items-center px-3 py-3 mx-auto mt-6 text-center bg-white border-2 border-dashed rounded-lg cursor-pointer dark:border-gray-600 dark:bg-gray-900">
                            ...
                            <input {...register('image', { required: 'image must be required' })} name='image' id="dropzone-file" type="file" className="hidden" />
                        ...
                        <div className='mt-4'>
                            ...
                            <select  {...register('userType')} defaultValue={'regular'} className='w-full py-2 px-4  text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300'>
                    ...
                    <Link onClick={handleGoogleSignUp} href="#" className="flex items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <div className="mt-6 text-center ">
                        <p href="#" className="text-sm   ">
                            Already have an account please <Link to={'/login'} className='hover:underline text-blue-500'>Login</Link>
                        </p>
                    </div>

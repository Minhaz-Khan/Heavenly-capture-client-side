        ...
        <div className='mt-6'>
            ...
            <section className="container px-4 mx-auto">
                <div className="flex items-center justify-center gap-x-3">
                    <h2 className="text-3xl border-b-2 border-lightSecondary text-lightSecondary font-medium uppercase ">My prodcuts</h2>
                </div>
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                        {myProduct && myProduct.map(product => <tr key={product._id}>
                                            ...
                                            <td>
                                                ...
                                                <h2 className="font-medium text-gray-800 dark:text-white ">{product.serviceName}</h2>


                                            </td>

                                            <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{product.packagePrice
                                            }</td>
                                            ...
                                            <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                <div className="flex items-center gap-x-6">
                                                    <button onClick={() => handleMyProductDelete(product._id)} className="text-gray-500 transition-colors duration-200 dark:hover:text-red-500 dark:text-gray-300 hover:text-red-500 focus:outline-none">
